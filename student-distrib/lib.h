...
extern void buffer_to_screen(int left);
void shift_video_mem();
extern void update_buffer_y();
void display_video(uint32_t terminal_num);
extern void set_vm_stutus();
extern void strcat(int8_t * dest, const int8_t * source, int size);


extern int32_t strncmp2(const int8_t* s1, const int8_t* s2, uint32_t n);

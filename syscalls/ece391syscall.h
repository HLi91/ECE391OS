...
extern int32_t ece391_umalloc (void);
extern int32_t ece391_modeX (int32_t buf, int32_t cmd);
extern int32_t ece391_modex_ent (void);
extern int32_t ece391_modex_quit(void);
